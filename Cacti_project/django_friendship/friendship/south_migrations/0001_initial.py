...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('django_friendship', ['FriendshipRequest'])
        ...
        db.send_create_signal('django_friendship', ['Friend'])
        ...
        db.send_create_signal('django_friendship', ['Follow'])
    ...
    models = {
        ...
        'django_friendship.friendshiprequest': {
    ...
    complete_apps = ['django_friendship']