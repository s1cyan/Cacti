...
class FriendshipRequest(models.Model):
    """ Model to represent django_friendship requests """
    ...
    def __str__(self):
        return "User #%d django_friendship requested #%d" % (self.from_user_id, self.to_user_id)

    def accept(self):
        """ Accept this django_friendship request """
    ...
    def reject(self):
        """ reject this django_friendship request """
    ...
    def cancel(self):
        """ cancel this django_friendship request """
        self.delete()
...
class FriendshipManager(models.Manager):
    ...
    def requests(self, user):
        """ Return a list of django_friendship requests """
    ...
    def sent_requests(self, user):
        """ Return a list of django_friendship requests from user """
    ...
    def unread_requests(self, user):
        """ Return a list of unread django_friendship requests """
    ...
    def unread_request_count(self, user):
        """ Return a count of unread django_friendship requests """
    ...
    def read_requests(self, user):
        """ Return a list of read django_friendship requests """
    ...
    def rejected_requests(self, user):
        """ Return a list of rejected django_friendship requests """
    ...
    def unrejected_request_count(self, user):
        """ Return a count of unrejected django_friendship requests """
    ...
    def add_friend(self, from_user, to_user, message=None):
        """ Create a django_friendship request """
    ...
    def remove_friend(self, to_user, from_user):
        """ Destroy a django_friendship relationship """
        try:
