...
def view_friends(request, username, template_name='django_friendship/friend/user_list.html'):
...
@login_required
def friendship_add_friend(request, to_username, template_name='django_friendship/friend/add.html'):
...
def friendship_accept(request, friendship_request_id):
    """ Accept a django_friendship request """
    if request.method == 'POST':
...
def friendship_reject(request, friendship_request_id):
    """ Reject a django_friendship request """
    if request.method == 'POST':
        f_request = get_object_or_404(
            request.user.friendship_requests_received,
            id=friendship_request_id)
...
@login_required
def friendship_request_list(request, template_name='django_friendship/friend/requests_list.html'):
    """ View unread and read django_friendship requests """
...
@login_required
def friendship_request_list_rejected(request, template_name='django_friendship/friend/requests_list.html'):
    """ View rejected django_friendship requests """
...
@login_required
def friendship_requests_detail(request, friendship_request_id, template_name='django_friendship/friend/request.html'):
    """ View a particular django_friendship request """
    f_request = get_object_or_404(FriendshipRequest, id=friendship_request_id)

    return render(request, template_name, {'friendship_request': f_request})


def followers(request, username, template_name='django_friendship/follow/followers_list.html'):
...
def following(request, username, template_name='django_friendship/follow/following_list.html'):
...
@login_required
def follower_add(request, followee_username, template_name='django_friendship/follow/add.html'):
...
@login_required
def follower_remove(request, followee_username, template_name='django_friendship/follow/remove.html'):
...
def all_users(request, template_name="django_friendship/user_actions.html"):
