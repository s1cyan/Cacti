...
@register.inclusion_tag('django_friendship/templatetags/friends.html')
def friends(user):
    """
...
@register.inclusion_tag('django_friendship/templatetags/followers.html')
def followers(user):
    """
...
@register.inclusion_tag('django_friendship/templatetags/following.html')
def following(user):
    """
...
@register.inclusion_tag('django_friendship/templatetags/friend_requests.html')
...
@register.inclusion_tag('django_friendship/templatetags/friend_request_count.html')
...
@register.inclusion_tag('django_friendship/templatetags/friend_count.html')
...
@register.inclusion_tag('django_friendship/templatetags/friend_rejected_count.html')
